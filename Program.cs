...
public class Product
{
    ...
    public int Price { get; set; }    // цена в рублях
...
public class VendingMachine
{
    ...
    private int[] coins = { 1, 2, 5, 10 }; // номиналы монет
    private int insertedMoney = 0;         // сколько внес пользователь
    private int totalSales = 0;            // сколько заработал автомат
